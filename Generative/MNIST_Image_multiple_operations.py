...
from tensorflow.keras.layers import Input, Conv2D, MaxPooling2D, Flatten, Dense, concatenate, Reshape, Conv2DTranspose, Multiply, BatchNormalization, Activation
...
def build_shared_cnn(input_shape, conv_layers, filters, kernel_size, pool_size, activation):
    ...
    for i in range(conv_layers):
        ...
        # x = Activation(activation)(x)  # Apply activation after normalization
...
if MULTIPLE_TRAINING:
    ...
    configurations = [
       
        {
            ...
            'pool_size': [2, 2, 2, 2],
            'activation': 'relu',
            'latent_size': 256,  # Increased latent size for a richer latent space
            ...
            'learning_rate': 0.001,
            'batch_size': 32,
            'epochs': 12,  # Reduced to match the updated requirements
        },
    ...
    for i, config in enumerate(configurations):
        ...
        model_name = f'ModelResults/final_50k_12iter.h5'
        ...
        history_path = f'HistoryResults/final_50k_12iter.npy'
